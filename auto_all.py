...
def generate_start_urls():
    ...
    end = int(df_start.iloc[0])
    no = 1000
    start = end - no
    print(start)
    return ['https://www.allianceauctions.com.au/cp_veh_Inspection_report.aspx?sitekey=ALL&MTA={}'.format(cat_number) for cat_number in range(int(start),int(end))]
